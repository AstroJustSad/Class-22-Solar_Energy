...
function draw() 
{
  ...
  panel1_voltage = round(absorbed1 * 0.15); // To reduce speed of getting a higher value.
...
function charge1(sprite1) {

  sprite1.remove();
  absorbed1 += 1; // Formula of increasing absorbed1 value.

}

function charge2(sprite1) {
